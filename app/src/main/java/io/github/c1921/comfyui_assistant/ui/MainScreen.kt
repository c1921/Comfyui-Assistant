...
fun MainScreen(
    ...
    onDeleteAlbumMedia: (Set<AlbumMediaKey>, AlbumMediaKey?) -> Unit,
        ...
        Column(
            ...
            when (selectedTab) {
                ...
                MainTab.Album -> AlbumScreen(
                    ...
                    onDeleteMedia = onDeleteAlbumMedia,
                ...
                MainTab.Settings -> SettingsScreen(
                    ...
                    onWebDavEnabledChanged = onWebDavEnabledChanged,
                    onWebDavServerUrlChanged = onWebDavServerUrlChanged,
                    onWebDavUsernameChanged = onWebDavUsernameChanged,
                    onWebDavPasswordChanged = onWebDavPasswordChanged,
                    onWebDavSyncPassphraseChanged = onWebDavSyncPassphraseChanged,
